package app.lifewin.ui.views.calendar;
...
import app.lifewin.ui.views.calendar.format.ArrayWeekDayFormatter;
import app.lifewin.ui.views.calendar.format.DateFormatTitleFormatter;
import app.lifewin.ui.views.calendar.format.DayFormatter;
import app.lifewin.ui.views.calendar.format.MonthArrayTitleFormatter;
import app.lifewin.ui.views.calendar.format.TitleFormatter;
import app.lifewin.ui.views.calendar.format.WeekDayFormatter;
...
public class MaterialCalendarView extends ViewGroup {
    ...
    /**
     * Set a {@linkplain app.lifewin.ui.views.calendar.format.WeekDayFormatter}
     * with the provided week day labels
     *
     * @param weekDayLabels Labels to use for the days of the week
     * @see app.lifewin.ui.views.calendar.format.ArrayWeekDayFormatter
     * @see #setWeekDayFormatter(app.lifewin.ui.views.calendar.format.WeekDayFormatter)
     */
    ...
    /**
     * Set a {@linkplain app.lifewin.ui.views.calendar.format.TitleFormatter}
     * using the provided month labels
     *
     * @param monthLabels month labels to use
     * @see app.lifewin.ui.views.calendar.format.MonthArrayTitleFormatter
     * @see #setTitleFormatter(app.lifewin.ui.views.calendar.format.TitleFormatter)
     */
