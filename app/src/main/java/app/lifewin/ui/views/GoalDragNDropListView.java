 ...
 * 
 */
public class GoalDragNDropListView extends ExpandableListView {
	...
	private int defaultBackgroundColor=0xdfdd3366;
	private float screenHeight;
	private float dragRatio;
	private ImageView mDragView;
	private GoalDragNDropAdapter adapter;
	...
	public GoalDragNDropListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	...
	public void setAdapter(ExpandableListAdapter adapter) {
		...
		this.adapter = (GoalDragNDropAdapter) adapter;
	}
