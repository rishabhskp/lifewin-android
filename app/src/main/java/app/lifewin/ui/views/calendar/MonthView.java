...
import app.lifewin.ui.views.calendar.MaterialCalendarView.ShowOtherDates;
import app.lifewin.ui.views.calendar.format.DayFormatter;
import app.lifewin.ui.views.calendar.format.WeekDayFormatter;

import static app.lifewin.ui.views.calendar.MaterialCalendarView.SHOW_DEFAULTS;
import static app.lifewin.ui.views.calendar.MaterialCalendarView.showOtherMonths;
...
class MonthView extends ViewGroup implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v instanceof DayView) {
            ...
            if(!dayView.getDate().isAfter(CalendarDay.today())){
